...
import { useLeadPpt } from "@/hooks/useLeadPpt";
...
import { LeadPptCard, LeadPptActionButton } from "@/components/leads/LeadPptCard";
...
export default function LeadDetail({ params }: { params: Promise<{ id: string }> }) {
  ...
  const ppt = useLeadPpt(lead?.id ?? null);
    ...
    <div className="p-6 max-w-7xl">
      ...
      <div className="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden mb-5">
        ...
        <div className="p-5 flex items-start justify-between gap-4 flex-wrap">
          ...
          <div className="flex items-center gap-2 flex-shrink-0">
            ...
            <LeadPptActionButton ppt={ppt} scoringStatus={effectiveStatus} />
            {convertedDealId ? (
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-5">
        ...
        <div className="space-y-4">
          ...
          {/* Pitch Deck */}
          <LeadPptCard ppt={ppt} scoringStatus={effectiveStatus} />
